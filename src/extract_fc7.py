...
#        print "Name", opn.name, opn.values()
    ...
    all_data = data_loader.load_questions_answers(args.data_dir)
    if args.split == "train":
    ...
    # 统计图片数量
    image_id_list = [int(img_id) for img_id in image_ids]
    ...
    while idx < len(image_id_list):
        ...
        for i in range(0, args.batch_size):
            ...
            image_file = join(args.data_dir, 'image/COCO_image2014_%.12d.jpg'%(image_id_list[idx]) )
